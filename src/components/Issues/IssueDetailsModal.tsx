  ...
  useEffect(() => {
    const fetchResolverName = async () => {
      ...
      try {
        ...
        // console.error('Error fetching resolver name:', _error);
        setResolverName('');
      } finally {
    ...
    <div className='fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center z-50 p-4'>
      <div className='bg-white dark:bg-gray-800 rounded-lg shadow-xl max-w-2xl w-full max-h-[90vh] overflow-y-auto'>
        <div className='flex justify-between items-center p-6 border-b border-gray-200 dark:border-gray-700'>
          <h2 className='text-xl font-semibold text-gray-900 dark:text-gray-100'>Issue Details</h2>
        ...
        <div className='p-6 space-y-6'>
          ...
          <div className='grid grid-cols-1 md:grid-cols-2 gap-6'>
            <div className='space-y-2'>
              ...
              <div className='space-y-1'>
                <p className='text-sm'>
                  <span className='font-medium'>Name:</span> {issue.reporter?.name || ''}
                </p>
                <p className='text-sm'>
